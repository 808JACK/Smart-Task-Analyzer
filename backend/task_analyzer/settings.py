...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-@c5y58u*6eb9-(9r8z055i40g9jlz+04r&0jx-itq#yqw0z#(e')
...
# Use DATABASE_URL if provided (for PostgreSQL/Neon), otherwise use SQLite
